...
import huminityIcon from "../../assets/icons/humidity.png";
// import huminityIcon from "../../assets/humidity.png";
const AirConditionsItem = (props) => {
  ...
  if (props.type === 'temperature')
    ...
    iconContent = (
      <img className='w-[30px]' src={huminityIcon} alt="" />
      // <SvgIcon
      //   component={huminityIcon}
      //   inheritViewBox
      //   sx={{ fontSize: "18px" }}
      // />
    );
